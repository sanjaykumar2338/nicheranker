...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{url('/')}}/asset/admin/plugins/newka/css/all.min.css">
  <!-- Sweet Alert 2 -->
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@11.10.7/dist/sweetalert2.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
  <!-- Tempusdominus Bbootstrap 4 -->
  <link rel="stylesheet" href="{{url('/')}}/asset/admin/plugins/newka/css/tempusdominus-bootstrap-4.min.css">
  <!-- iCheck -->
  <link rel="stylesheet" href="{{url('/')}}/asset/admin/plugins/newka/css/icheck-bootstrap.min.css">
  <!-- JQVMap -->
  <link rel="stylesheet" href="{{url('/')}}/asset/admin/plugins/newka/css/jqvmap.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="{{url('/')}}/asset/admin/dist/css/adminlte.min.css">
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="{{url('/')}}/asset/admin/plugins//newka/css/OverlayScrollbars.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{url('/')}}/asset/admin/plugins//newka/css/daterangepicker.css">
  <!-- summernote -->
  <link rel="stylesheet" href="{{url('/')}}/asset/admin/plugins/newka/css/summernote-bs4.css">
...
<!-- jQuery -->
<script src="{{url('/')}}/asset/admin/plugins/newka/js/jquery.min.js"></script>
<!-- jQuery UI 1.11.4 -->
<script src="{{url('/')}}/asset/admin/plugins/newka/js/jquery-ui.min.js"></script>
<!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->
<script>
  $.widget.bridge('uibutton', $.ui.button)
</script>
<!-- Bootstrap 4 -->
<script src="{{url('/')}}/asset/admin/plugins/newka/js/bootstrap.bundle.min.js"></script>
<!-- ChartJS -->
<script src="{{url('/')}}/asset/admin/plugins/newka/js/Chart.min.js"></script>
<!-- Sparkline -->

<!-- JQVMap -->
<script src="{{url('/')}}/asset/admin/plugins/newka/js/jquery.vmap.min.js"></script>
<script src="{{url('/')}}/asset/admin/plugins/newka/js/jquery.vmap.usa.js"></script>
<!-- jQuery Knob Chart -->
<script src="{{url('/')}}/asset/admin/plugins/newka/js/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="{{url('/')}}/asset/admin/plugins/newka/js/moment.min.js"></script>
<script src="{{url('/')}}/asset/admin/plugins/newka/js/daterangepicker.js"></script>
<!-- Tempusdominus Bootstrap 4 -->
<script src="{{url('/')}}/asset/admin/plugins/newka/js/tempusdominus-bootstrap-4.min.js"></script>
<!-- Summernote -->
<script src="{{url('/')}}/asset/admin/plugins/newka/js/summernote-bs4.min.js"></script>
<!-- overlayScrollbars -->
<script src="{{url('/')}}/asset/admin/plugins/newka/js/jquery.overlayScrollbars.min.js"></script>
<!-- AdminLTE App -->
